    ...
    >
      ...
      <AnimatePresence>
        <motion.div
          ...
          key={"modal-div"}
          className={twMerge(
            "w-full max-w-full lg:max-w-[MIN(90%,600px)] h-full min-h-[300px] pb-2 overflow-hidden mt-auto lg:m-auto bg-white flex flex-col relative rounded-t-4xl lg:rounded-4xl border overflow-y-auto z-[999] max-h-[95dvh]",
            className
          )}
        >
          <header
