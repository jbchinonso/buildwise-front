    ...
    >
      ...
      <AnimatePresence>
        <motion.div
          ...
          key={"modal-div"}
          className={twMerge(
            "w-full ma.x-w-[95%] lg:max-w-[MIN(90%,600px)] h-full min-h-[300px] pb-2 overflow-hidden mt-auto lg:m-auto rounded-t-4xl lg:rounded-4xl bg-white flex flex-col relative  border overflow-y-auto z-[999] gap-6 max-h-[95dvh]",
            className
          )}
        >
          <header
          ...
          <div className="relative flex flex-col flex-1 px-6 sm:px-7 pb-5 mb-5 w-full max-h-[90dvh] overflow-y-auto border-t border-white/[0.06] bg-inherit mx-auto">
            {children}
          </div>
        </motion.div>
      </AnimatePresence>
